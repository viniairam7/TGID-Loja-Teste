...
public class UsuarioTestes {
    ...
    public void testGetters() {
        ...
        Usuario usuario = new Usuario("João", "123.456.789-00", "joao@email.com", "Rua Alves de Souza, 22 - Osasco");

        
        assertEquals("Vinicius", usuario.getNome(), "O nome do usuário deve ser Vinicius");
